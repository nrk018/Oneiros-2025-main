...
const SidebarItem = ({ label, active, onSelect }: SidebarItemProps) => {
  return (
    <button
      onClick={onSelect}
      ...
      className={`
        ...
        after:duration-300
        ${active
          ? "bg-gradient-to-r from-black-400/20 via-purple-400/10 to-transparent text-white after:bg-red-400"
          : "hover:bg-black-400/10 text-gray-400 hover:text-gray-200 after:bg-black-400 after:scale-y-0 hover:after:scale-y-100"
        }
      `}
    >
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 w-64 bg-black border-r border-gray-800 z-50 lg:hidden overflow-y-auto"
          >
...
function MemberCard({ member }: { member: TeamMember }) {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-gray-800/50 backdrop-blur-sm overflow-hidden rounded-xl shadow-lg border-2 border-transparent hover:border-red-500 transition-all duration-300"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      {/* Card Border */}
      <div className="absolute inset-0 rounded-xl border-2 border-gradient-to-r from-red-500 to-purple-500 pointer-events-none"></div>
      ...
      <motion.div
        ...
        transition={{ duration: 0.3 }}
      >
        <h2 className="text-xl font-semibold text-white mb-2 group-hover:text-white transition-colors relative z-10 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">
          {member.name}
        </h2>
        <p className="text-sm text-gray-300 font-light transition-colors group-hover:text-white group-hover:drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]">
          {member.position}
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        transition={{ duration: 0.3 }}
      >
        <div className="absolute inset-0 rounded-xl border-2 border-gradient-to-r from-red-500 to-purple-500 animate-pulse"></div>
        <div className="absolute inset-0 rounded-xl border-2 border-gradient-to-r from-red-500 to-purple-500 blur-md"></div>
      </motion.div>
    </motion.div>
  );
}
...
export default function TeamsPage() {
  ...
  const gradientTextClass = "bg-gradient-to-r from-red-500 via-purple-500 to-red-500 text-transparent bg-clip-text animate-gradient [text-shadow:0_0_5px_rgba(255,0,128,0.3),0_0_10px_rgba(255,0,128,0.2),0_0_15px_rgba(255,0,128,0.1)]";
  ...
  const TeamsHeader = () => (
    <div className="relative px-4 py-3 bg-black border-b border-gray-800 z-20">
      <h2 className={`text-3xl font-bold text-center ${gradientTextClass}`}>
        OUR TEAMS
      </h2>
      <div className="h-[40px] w-full relative mt-1">
        <div className="absolute inset-x-4 top-1 bg-gradient-to-r from-transparent via-red-500 to-transparent h-[2px] w-3/4 blur-sm" />
        <div className="absolute inset-x-4 top-1 bg-gradient-to-r from-transparent via-red-500 to-transparent h-px w-3/4" />
        <div className="absolute inset-x-20 top-1 bg-gradient-to-r from-transparent via-purple-500 to-transparent h-[5px] w-1/4 blur-sm" />
        <div className="absolute inset-x-20 top-1 bg-gradient-to-r from-transparent via-purple-500 to-transparent h-px w-1/4" />
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col lg:flex-row">
      ...
      {/* Mobile Header (Fixed) */}
      <div className="lg:hidden flex items-center justify-between p-4 border-b border-gray-800 fixed top-0 left-0 right-0 z-10 bg-black">
        <button
        ...
        <h3 className={`text-xl font-bold ${gradientTextClass}`}>
          {getHeaderText()}
        </h3>
        <div className="w-6" />
      </div>
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block fixed top-0 left-0 bottom-0 w-64 border-r border-gray-800 overflow-y-auto bg-black shadow-lg">
        <TeamsHeader />
        <NavigationItems />
      </aside>

      {/* Main Content */}
      <main className="flex-grow overflow-y-auto bg-black p-4 lg:p-6 lg:ml-64 min-h-screen pt-20">
        <AnimatePresence mode="wait">
          {selection.type === "conveners" ? (
            ...
            >
              ...
              <h1 className={`text-2xl lg:text-3xl font-bold mb-6 lg:block ${gradientTextClass}`}>Conveners</h1>
            ...
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <h1 className={`text-2xl lg:text-3xl font-bold mb-6 lg:block ${gradientTextClass}`}>Managing Directors</h1>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            >
              <section className="mb-6">
                <h2 className={`text-2xl font-bold mb-4 lg:block ${gradientTextClass}`}>Executive Committee</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              <section>
                <h2 className={`text-2xl font-bold mb-4 lg:block ${gradientTextClass}`}>Core Committee</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
